...
var probablity = new Probablity;
//multi choose usage example
var A = [
    {
        name: 'blue',
        count: 1
...
var p = probablity.multiChoose(A, S);
console.log(p);
//single choose usage example
p = probablity.singleChoose([2, 4, 6], [1, 2, 3, 4, 5, 6], {
    select: 3,
    decimals: 5
});
console.log(p);
p = probablity.singleChoose([1, 6], [1, 2, 3, 4, 5, 6], {
    decimals: 8
});
console.log(p);
